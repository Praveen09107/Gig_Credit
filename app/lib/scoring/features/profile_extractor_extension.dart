...
extension ProfileFeatureExtractor on VerifiedProfile {
  double? extractFeature(String key) {
    switch (key) {
      ...
      case 'avg_monthly_income_norm': return bankInfo.monthlyIncome; // scale down usually
      ...
      case 'aadhaar_verified': return kycInfo.isAadhaarVerified ? 1.0 : 0.0;
      case 'pan_verified': return kycInfo.isPanVerified ? 1.0 : 0.0;
      
      // SOURCE 3 — Insurance
      case 'health_insurance_active': return insuranceInfo.hasHealthInsurance ? 1.0 : 0.0;
      
      // SOURCE 4 — ITR/GST
      case 'itr_filed_binary': return taxInfo.hasITR ? 1.0 : 0.0;
