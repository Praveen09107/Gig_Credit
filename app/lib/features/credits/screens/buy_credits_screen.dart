    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          AppCard(
            ...
            child: Column(
              children: [
                ...
                Text('credits', style: TextStyle(color: AppColors.textTertiary)),
              ],
            ),
          ),
          ...
          const SizedBox(height: 12),
          _InfoRow(icon: Icons.generating_tokens, text: 'Each credit report costs 1 credit to generate.'),
          const SizedBox(height: 8),
          _InfoRow(icon: Icons.card_giftcard, text: 'New users get 1 free credit on signup.'),
          const SizedBox(height: 8),
          _InfoRow(icon: Icons.refresh, text: 'Credits never expire once purchased.'),
        ],
      ),
    );
  }
                  ...
                  children: [
                    ...
                    if (isPopular) ...[
                      ...
                      Container(
                        ...
                        child: Text('BEST VALUE', style: TextStyle(color: AppColors.gradeA, fontSize: 10, fontWeight: FontWeight.bold)),
                      ),
                    ],
                  ],
                ),
